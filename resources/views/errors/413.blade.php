                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                             <h1 class="display-3 text-danger font-weight-bold">Access denied</h1>
                        </div>
                        <div class="card-body">
                            <div class="alert alert-danger text-center">
                <p class="display-5">Oops! Something is wrong.</p>
                <h3> Please you are not authorized to access this page</h3>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row card-footer">
                                    ...
                                    {{--  <div class="col">  --}}
                                        <a href="{{ $url }}" class="btn btn-lg btn-dark float-right mx-2" style="color: #E91E63;">Dashboard</a>
                                    {{--  </div>  --}}
                                </div>
                            </div>
                        </div>
...
<head>
	<title>Smart Attendance with QR code :: server errors</title>
	<!-- Meta tag Keywords -->
			...
			<div class="container mt-5 pt-5">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header">
                                 <h1 class="display-3 text-danger font-weight-bold">500</h1>
                            </div>
                            <div class="card-body">
                                <div class="alert alert-danger text-center">
                    <p class="display-5">Oops! Something is wrong.</p>
