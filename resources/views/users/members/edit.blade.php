    ...
    <section class="section">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body p-3">
                <form action="{{ route('members.update', Auth::user()->id) }}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" value="{{ Auth::user()->email, old('email') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{ Auth::user()->phone, old('phone') }}" name="phone"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="file" name="avatar"
                                    class="form-control {{ $errors->has('avatar') ? ' is-invalid' : '' }}" id="usr">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea name="about" id=""
                                    class="form-control {{ $errors->has('about') ? ' is-invalid' : '' }}" cols="20"
                                    rows="10">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="currentp"
                                            class="form-control {{ $errors->has('currentp') ? ' is-invalid' : '' }}"
                                            id="usr">
