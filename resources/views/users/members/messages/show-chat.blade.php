                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <a class="nav-link" url ="{{ route('mychat', [$user->id, str_replace(" ", '_', $user->name)]) }}" img="{{ $user->getMedia('avatar')->first()->getFullUrl() }}" href="#message" username="{{ ucwords($user->name) }}" userid="{{ $user->id   }}" data-toggle="modal"><span class="btn btn-sm btn-rounded btn-danger text-light">Quick message</span></a>
                        </td>
                    </tr>
                    @endforeach
                  </tbody>
      ...
      <div class="modal" id="message">
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                <a href="{{ route('mychat', [$user->id, str_replace(" ", '_', $user->name)]) }}" class="btn btn-success float-left" id="fmessage">View our full conversation</a>
