                        ...
                        @forelse ($messages as $message)
                            ...
                            <li class="list-group-item ml-auto border-0 d-flex align-items-center px-0 mb-2">
                                <div class="avatar me-3">
                                  <img src="{{ Auth::user()->getMedia('avatar')->first()->getFullUrl('avatar'); }}" alt="kal" class="border-radius-lg shadow">
                                </div>
                                <div class="d-flex align-items-start flex-column justify-content-center">
                                  <h6 class="mb-0 text-sm">{{ ucwords(Auth::user()->name) }}</h6>
                                  {!! $message->message !!}
                                  <small>
                                    <p>{{ $message->user->timeago($message->created_at) }}</p>
                                </small>
                                </div>
                            ...
                            <li class="list-group-item border-0 d-flex align-items-center px-0 mb-2">
                                <div class="avatar me-3">
                                  <img src="{{ $message->user->getMedia('avatar')->first()->getFullUrl('avatar'); }}" alt="kal" class="border-radius-lg shadow">
                                </div>
                                <div class="d-flex align-items-start flex-column justify-content-center">
