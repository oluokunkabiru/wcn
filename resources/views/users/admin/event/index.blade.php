                                ...
                                <div class="position-relative">
                                    <a class="d-block shadow-xl border-radius-xl">
                                        <img style="height: 150px; width:100%"
                                            src="{{ $event->getMedia('events')->first()->getFullUrl() != ''
    ? $event->getMedia('events')->first()->getFullUrl()
    : '../assets/img/home-decor-1.jpg' }}"
                                            alt="{{ $event->title }}" class="img-fluid shadow border-radius-xl">
                                    </a>
                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    Project</button> --}}
                                        <a href="{{ route('readEvent', [$event->id, str_replace(' ', '_', $event->title)]) }}"
                                            data-toggle="tooltip" title="Read event" class="btn btn-success  "><span
                                                class="fa fa-eye"></span></a>
                                        <a href="{{ route('events.edit', $event->id) }}" class="btn btn-primary"
                                            data-toggle="tooltip" title="Edit event"><span
                                                class="fa fa-edit"></span></a>
                                        <a href="#confirm" data-toggle="modal" class="btn btn-danger"
                                            event-title="{{ $event->title }}"
                                            event-url={{ route('events.destroy', $event->id) }} data-toggle="tooltip"
                                            title="Delete Event"><span class="fa fa-trash"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
