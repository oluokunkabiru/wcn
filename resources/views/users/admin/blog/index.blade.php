...
@section('content')
    ...
    : '../assets/img/home-decor-1.jpg' }}"
                                            alt="{{ $blog->title }}" class="img-fluid shadow border-radius-xl">
                                    </a>
                                </div>
                                <div class="card-body px-1 pb-0" style="height: 200px; overflow:hidden">
                                    <a href="javascript:;">
                                        <h5>
                                            {{ $blog->title }} <span
                                                class="fa fa-comment">{{ $blog->getNumbersOfComment($blog->id) }}</span>
                                        </h5>
                                    </a>
                                ...
                                <div class="card-footer">
                                    ...
                                    Project</button> --}}
                                        <a href="{{ route('readblog', [$blog->id, str_replace(' ', '_', $blog->title)]) }}"
                                            data-toggle="tooltip" title="Read full content" class="btn btn-success  "><span
                                                class="fa fa-eye"></span></a>
                                        <a href="{{ route('blogs.edit', $blog->id) }}" data-toggle="tooltip"
                                            title="Edit content" class="btn btn-primary  "><span
                                                class="fa fa-edit"></span></a>
                                        <a href="#confirm" data-toggle="modal" class="btn btn-danger"
                                            blog-title="{{ $blog->title }}"
                                            blog-url={{ route('blogs.destroy', $blog->id) }} data-toggle="tooltip"
                                            title="Delete content"><span class="fa fa-trash"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title text-uppercase">are sure you want delete <span
                            id="delname"></span></h4>
