        ...
        <div class="card mb-4">
            ...
            <div class="card-body p-3">
                ...
                <div class="row">
                            ...
                            <div class="card card-blog card-plain">
                                ...
                                <div class="card-footer">
                                    ...
                                    Project</button> --}}
                                        ...
                                        <a href="#approve" data-toggle="modal" testi="{!! $unapprove->testimony !!}"
                                            status={{ $unapprove->status }}
                                            url="{{ route('testimony-approve', [$unapprove->id, $unapprove->status]) }}"
                                            title="{{ $unapprove->status == 0 ? 'approve testimony' : 'disable testimony' }}"
                                            class="btn btn-primary  "><span
                                                class="fa {{ $unapprove->status == 0 ? 'fa-check' : 'fa-times' }}"></span></a>
                    ...
                    @empty
                        <h2 class="text-center text-danger">No pending testimony</h2>
                    @endforelse
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="row">
                        ...
                        @empty
                            <h2 class="text-center text-danger">No approved testimony</h2>
                        @endforelse
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <a href="" id="approve-url" class="btn btn-success btn-rounded"><span id="tatus"></span></a>
                </div>
            </div>
        </div>
    </div>
