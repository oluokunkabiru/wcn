                        ...
                        <div class="card-footer">
                            <div class="d-flex align-items-center justify-content-between">
                                {{--  <button type="button" class="btn btn-outline-primary btn-sm mb-0">View
                                    ...
                                    <a href="#approve" data-toggle="modal" testi ="{!! $unapprove->testimony !!}" status={{ $unapprove->status }} url="{{ route('testimony-approve', [$unapprove->id, $unapprove->status]) }}" title="{{ $unapprove->status==0?"approve testimony":"disable testimony" }}" class="btn btn-primary  "><span class="fa {{ $unapprove->status==0 ? "fa-check":"fa-times" }}"></span></a>
