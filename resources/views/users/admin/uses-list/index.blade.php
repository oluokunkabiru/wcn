                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <p class="text-xs font-weight-bold mb-0">
                                                            {{ ucwords($user->role) }}</p>
                                                        <p class="text-xs text-secondary mb-0">{{ $user->created_at }}
                                                        </p>
                                                    </td>
                                                    <td class="align-middle text-center text-sm">
                                                        <span
                                                            class="badge badge-sm {{ $user->status == 0 ? 'bg-gradient-danger' : 'bg-gradient-success' }} ">{{ $user->status == 0 ? 'Unapprove' : 'Approved' }}</span>
                                                    </td>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="#edit{{ $user->id }}" data-toggle="collapse"
                                                            class="text-white btn btn-dark font-weight-bold text-xs"
                                                                ...
                                                                @if ($user->role == 'admin')
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" href="#admin"
                                                                            data-toggle="modal" role="{{ $user->role }}"
                                                                            username="{{ $user->name }}"
                                                                            url="{{ route('make-users-admin', [$user->id]) }}"><span
                                                                                class="btn btn-sm btn-rounded btn-secondary text-light">Withdraw
                                                                                admin</span></a>
                                                                    </li>
                                                                @else
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" href="#admin"
                                                                            ...
                                                                            username="{{ $user->name }}"
                                                                            url="{{ route('make-users-admin', [$user->id]) }}"><span
                                                                                class="btn btn-sm btn-rounded btn-secondary text-light">Make
                                                                                admin</span></a>
                                                                    </li>
                                                                @endif
                                                                ...
                                                                @if ($user->position != null)
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            ...
                                                                            href="#minister" data-toggle="modal"
                                                                            role="{{ $user->role }}"
                                                                            username="{{ $user->name }}"
                                                                            url="{{ route('ministers.update', [$user->id]) }}"><span
                                                                                class="btn btn-sm btn-rounded btn-info text-light">Withdraw
                                                                                Ministering</span></a>
                                                                    </li>
                                                                @else
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            ...
                                                                            username="{{ $user->name }}"
                                                                            url="{{ route('ministers.update', [$user->id]) }}"><span
                                                                                class="btn btn-sm btn-rounded btn-info text-light">Make
                                                                                Minister</span></a>
                                                                    </li>
                                                                @endif
                                                                ...
                                                                @if ($user->status == 0)
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            ...
                                                                            url="{{ route('approve-users', [$user->id, $user->status]) }}"
                                                                            href="#approve" data-toggle="modal"><span
                                                                                class="btn btn-sm btn-rounded btn-success text-light">Approve</span></a>
                                                                    </li>
                                                                @else
                                                                    <li class="nav-item">
                                                                        <a class="nav-link"
                                                                            ...
                                                                            url="{{ route('approve-users', [$user->id, $user->status]) }}"
                                                                            href="#approve" data-toggle="modal"><span
                                                                                class="btn btn-sm btn-rounded btn-warning text-dark">Disable</span></a>
                                                                    </li>
                                                                @endif
                                                                ...
                                                                <li class="nav-item">
                                                                    <a class="nav-link"
                                                                        ...
                                                                        data-toggle="modal"><span
                                                                            class="btn btn-sm btn-rounded btn-danger text-light">Private
                                                                            message</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h4 class="modal-title text-uppercase">are sure you want <span id="status"></span> <span
                            id="delname"></span></h4>
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success text-uppercase">update user approval
                        status</button>
                </div>
                </form>
            </div>
    ...
    <div class="modal" id="admin">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success text-uppercase">update admin</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal" id="minister">
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <form id="minform" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="about" id="about"
                                class="form-control {{ $errors->has('about') ? ' is-invalid' : '' }}" cols="10"
                                rows="5">
                            </textarea>
                            @if ($errors->has('about'))
                                <span class="invalid-feedback" role="alert">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success text-uppercase">Update Ministering status</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#admin').on('show.bs.modal', function(e) {
                ...
                //   alert(statis);
                var status = statis == "member" ? "you want make " + name + " as admin" :
                    "you want withdraw admin from " + name;
                //  alert(status)
                // $("#delname").text(mycat);
            ...
            $('#minister').on('show.bs.modal', function(e) {
                ...
                var statis = $(e.relatedTarget).attr('role');
                //   alert(statis);
                var status = statis == "member" ? "you want make " + name + " as minister" :
                    "you want withdraw minister from " + name;
                //  alert(status)
                // $("#delname").text(mycat);
